...
/*
 * Now that we have gone through the pain of reading the inspanidual types, we're
 ...
 * that when we do the spanision, it will be treated as a bit shift and we won't
 ...
 * iterating and spaniding by 2. We may want to come back and revisit that some
 * day.
 */
function log2(value)
{
 ...
 * spanide by 2^32. Once we've done that we can use binary arithmetic. Oof,
