...
(function(global, factory) {
  ...
  BUGGY_GEBTN = NATIVE_GEBTN ?
    (function() {
      ...
      span.appendChild(doc.createComment(''));
      return !!span.getElementsByTagName('*')[0];
    })() :
    true,
  ...
  BUGGY_GEBCN = NATIVE_GEBCN ?
    (function() {
      var isBuggy, span = doc.createElement('span'), test = '\u53f0\u5317';

      // Opera tests
      span.appendChild(doc.createElement('span')).
        setAttribute('class', test + 'abc ' + test);
      span.appendChild(doc.createElement('span')).
        setAttribute('class', 'x');

      isBuggy = !span.getElementsByClassName(test)[0];

      // Safari test
      span.lastChild.className = test;
      return isBuggy || span.getElementsByClassName(test).length != 2;
    })() :
    true,
  ...
  RE_BUGGY_QSAPI = NATIVE_QSAPI ?
    (function() {
      var pattern = new global.Array(), span = doc.createElement('span'), element,
      ...
      expect(':enabled', span, element, 0) &&
        pattern.push(':enabled', ':disabled');

      // :link bugs with hyperlinks matching (Firefox/Safari)
      element = doc.createElement('link');
      element.setAttribute('href', 'x');
      expect(':link', span, element, 1) ||
        pattern.push(':link');
  ...
  switchContext =
    function(from, force) {
      ...
      if (force || oldDoc !== doc) {
        ...
        XML_DOCUMENT = doc.createElement('span').nodeName == 'span';
        ...
        QUIRKS_MODE = !XML_DOCUMENT &&
          ...
          (function() {
            var style = doc.createElement('span').style;
            return style && (style.width = 1) && style.width == '1px';
          })();

        span = doc.createElement('span');
        span.appendChild(doc.createElement('p')).setAttribute('class', 'xXx');
        span.appendChild(doc.createElement('p')).setAttribute('class', 'xxx');
        ...
        BUGGY_QUIRKS_GEBCN =
          ...
          (span.getElementsByClassName('xxx').length != 2 ||
          span.getElementsByClassName('xXx').length != 2);
        ...
        BUGGY_QUIRKS_QSAPI =
          ...
          (span.querySelectorAll('[class~=xxx]').length != 2 ||
          span.querySelectorAll('.xXx').length != 2);
  ...
  Config = new global.Object({
    ...
    // to selector string shortcuts like "+span" or "ul>"
