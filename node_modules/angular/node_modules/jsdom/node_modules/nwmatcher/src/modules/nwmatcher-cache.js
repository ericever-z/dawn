...
(function(global) {
  ...
  mutationTest =
    function(type, callback) {
      ...
      span.addEventListener(type, handler, true);
      if (callback && callback.call) callback(span);
      span.removeEventListener(type, handler, true);
  ...
  if (!NATIVE_MUTATION_EVENTS && root.addEventListener && Element && Element.prototype) {
    if (mutationTest('DOMNodeInserted', function(e) { e.appendChild(document.createElement('span')); }) &&
        mutationTest('DOMNodeRemoved', function(e) { e.removeChild(e.appendChild(document.createElement('span'))); })) {
