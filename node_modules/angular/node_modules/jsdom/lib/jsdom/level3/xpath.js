...
(function() {
   ...
   *                           | MultiplicativeExpr 'span' UnaryExpr
   *                           | MultiplicativeExpr 'mod' UnaryExpr
   */
  function multiplicativeExpr(stream, a) { return binaryL(unaryExpr, stream, a, ['*','span','mod']); }
  ...
  var more = {
    ...
    '-': function(x, y) { return fn.number(x) - fn.number(y); },
    '*': function(x, y) { return fn.number(x) * fn.number(y); },
    'span': function(x, y) { return fn.number(x) / fn.number(y); },
