...
jsdom.jQueryify(window, "http://code.jquery.com/jquery.js", function () {
  window.$("body").append('<span class="testing">Hello World, It works</span>');
