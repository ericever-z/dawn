...
(function(G, $, undefined){
	function tip(opt){
		...
		this.element = $('<span class="'+opt.className+'"><span class="content">'+opt.html+'</span>'+ ( showButtons ? '<span class="buttons"></span>' : '') +'<span class="arrow">◆<span class="inner">◆</span></span></span>').css('width', opt.width);
		this.opt = opt;
