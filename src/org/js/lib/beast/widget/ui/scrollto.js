 ...
 * @example $('span').scrollTo( 340 );
 *
 * @desc Scroll relatively to the actual position
 * @example $('span').scrollTo( '+=340px', { axis:'y' } );
 *
 * @dec Scroll using a selector (relative to the scrolled element)
 * @example $('span').scrollTo( 'p.paragraph:eq(2)', 500, { easing:'swing', queue:true, axis:'xy' } );
 *
 ...
 * @example $('span').scrollTo( { top: 300, left:'+=200' }, { axis:'xy', offset:-20 } );
 */
